...
Relevant files: `assistant/slack/server.mjs`, `assistant/slack/installations.mjs`, `assistant/slack/onboarding.mjs`, `assistant/watches.mjs`, `assistant/MULTI_PLATFORM.md`, and the new `assistant/send.mjs` + `assistant/teams/` tree.